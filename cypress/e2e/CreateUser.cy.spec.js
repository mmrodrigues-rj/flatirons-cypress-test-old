describe('User Registration Validation', () => {
  ...
  it('Should create a new user', () => {
    const randomEmail = `user${Date.now()}@server.com`;
    ...
    cy.get(':nth-child(3) > .sc-liQGml > .iZOaqm > .fhKwQl > [data-cy="html-input"]').type(randomEmail);
    cy.get(':nth-child(4) > .sc-liQGml > .iZOaqm > .fhKwQl > [data-cy="html-input"]').clear();
    cy.get(':nth-child(4) > .sc-liQGml > .iZOaqm > .fhKwQl > [data-cy="html-input"]').type('Test123!');
    cy.get('[data-cy="SignUp"]').click();
